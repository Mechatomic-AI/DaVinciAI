...
import { DaVinciCode } from './fragment-code'
import { DaVinciPreview } from './fragment-preview'
...
import { DaVinciSchema } from '@/lib/schema'
...
export function Preview({
  ...
  fragment?: DeepPartial<DaVinciSchema>
        ...
        {fragment && (
          <div className="overflow-y-auto w-full h-full">
            ...
            <TabsContent value="fragment" className="h-full">
              {result && <DaVinciPreview result={result as ExecutionResult} />}
            </TabsContent>
          </div>
        )}
      </Tabs>
